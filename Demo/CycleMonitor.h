...
// Construction
	...
	CCycleChild m_cyclechild[RV_MAX_CHANNUM];
	int m_curRow;//used to record the next position of current tail of current list//用于记录当前列表末尾位置的下一位置

	int m_curChild;//used to record the sub window of current attribute window//用于记录当前属性窗口的子窗口
