...
{
	PtzMemuControl(RV_EXTPTZ_MENUCANCEL);
}

void CDHPtzMenu::OnOprClosemenu() 
{
	PtzMemuControl(RV_EXTPTZ_CLOSEMENU);
}

void CDHPtzMenu::OnOprDown() 
{
	PtzMemuControl(RV_EXTPTZ_MENUDOWN);
}

void CDHPtzMenu::OnOprLeft() 
{
	PtzMemuControl(RV_EXTPTZ_MENULEFT);
}

void CDHPtzMenu::OnOprOk() 
{
	PtzMemuControl(RV_EXTPTZ_MENUOK);
}

void CDHPtzMenu::OnOprOpenmenu() 
{
	PtzMemuControl(RV_EXTPTZ_OPENMENU);
}

void CDHPtzMenu::OnOprRight() 
{
	PtzMemuControl(RV_EXTPTZ_MENURIGHT);
}

void CDHPtzMenu::OnOprUp() 
{
	PtzMemuControl(RV_EXTPTZ_MENUUP);
}
