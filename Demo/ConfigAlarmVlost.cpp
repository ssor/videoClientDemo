	...
	: CDialog(CConfigAlarmVlost::IDD, pParent)
{
	...
	//}}AFX_DATA_INIT
	m_pDev = 0;
	memset(m_vlostCFG, 0, RV_MAX_VIDEO_IN_NUM*sizeof(RV_VIDEO_LOST_CFG));
	m_bReady = FALSE;
	m_chlIdx = -1;
	m_weekIdx = -1;
	m_ptzchlIdx = -1;
...
void CConfigAlarmVlost::SetVlostCFG(RV_VIDEO_LOST_CFG *cfg)
{
	if (!cfg)
	{
		return;
	...
	memcpy(m_vlostCFG, cfg, RV_MAX_VIDEO_IN_NUM*sizeof(RV_VIDEO_LOST_CFG));
...
void CConfigAlarmVlost::OnSelchangeComboVideochl() 
{
	...
	m_vlostCFG[m_chlIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_UPLOAD))->GetCheck()?RV_ALARM_UPLOAD:0;
	m_vlostCFG[m_chlIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_LOCALTIP))->GetCheck()?RV_ALARM_TIP:0;
	m_vlostCFG[m_chlIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_LOCALTOUR))->GetCheck()?RV_ALARM_TOUR:0;
	m_vlostCFG[m_chlIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_SENDMAIL))->GetCheck()?RV_ALARM_MAIL:0;
	m_vlostCFG[m_chlIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_PTZ))->GetCheck()?RV_ALARM_PTZ:0;
	m_vlostCFG[m_chlIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_RECORD))->GetCheck()?RV_ALARM_RECORD:0;
	m_vlostCFG[m_chlIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_OUTPUT))->GetCheck()?RV_ALARM_OUT:0;
...
skipsave:
	...
	((CButton*)GetDlgItem(IDC_CHECK_UPLOAD))->SetCheck((m_vlostCFG[chlIdx].struHandle.dwActionFlag&RV_ALARM_UPLOAD)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_LOCALTIP))->SetCheck((m_vlostCFG[chlIdx].struHandle.dwActionFlag&RV_ALARM_TIP)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_LOCALTOUR))->SetCheck((m_vlostCFG[chlIdx].struHandle.dwActionFlag&RV_ALARM_TOUR)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_SENDMAIL))->SetCheck((m_vlostCFG[chlIdx].struHandle.dwActionFlag&RV_ALARM_MAIL)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_PTZ))->SetCheck((m_vlostCFG[chlIdx].struHandle.dwActionFlag&RV_ALARM_PTZ)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_RECORD))->SetCheck((m_vlostCFG[chlIdx].struHandle.dwActionFlag&RV_ALARM_RECORD)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_OUTPUT))->SetCheck((m_vlostCFG[chlIdx].struHandle.dwActionFlag&RV_ALARM_OUT)?1:0);
...
void CConfigAlarmVlost::GetVlostCFG(RV_VIDEO_LOST_CFG *cfg)
{
...
//	m_vlostCFG[m_chlIdx].wSenseLevel = GetDlgItemInt(IDC_EDIT_SENSELVL);
	...
	memcpy(cfg, m_vlostCFG, RV_MAX_ALARM_IN_NUM*sizeof(RV_VIDEO_LOST_CFG));
}
