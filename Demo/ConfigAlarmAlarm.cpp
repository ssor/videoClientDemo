	...
	: CDialog(CConfigAlarmAlarm::IDD, pParent)
{
	...
	//}}AFX_DATA_INIT
	m_pDev = 0;
	memset(m_alarmCFG, 0, RV_MAX_ALARM_IN_NUM*sizeof(RV_ALARMIN_CFG));
	m_bReady = FALSE;
	m_almIdx = -1;
	m_weekIdx = -1;
	m_ptzchlIdx = -1;
...
void CConfigAlarmAlarm::SetAlarmInCFG(RV_ALARMIN_CFG *cfg)
{
	if (!cfg)
	{
		return;
	}
	memcpy(m_alarmCFG, cfg, RV_MAX_ALARM_IN_NUM*sizeof(RV_ALARMIN_CFG));
...
void CConfigAlarmAlarm::OnSelchangeComboAlarmin() 
{
	...
	m_alarmCFG[m_almIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_UPLOAD))->GetCheck()?RV_ALARM_UPLOAD:0;
	m_alarmCFG[m_almIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_LOCALTIP))->GetCheck()?RV_ALARM_TIP:0;
	m_alarmCFG[m_almIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_LOCALTOUR))->GetCheck()?RV_ALARM_TOUR:0;
	m_alarmCFG[m_almIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_SENDMAIL))->GetCheck()?RV_ALARM_MAIL:0;
	m_alarmCFG[m_almIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_PTZ))->GetCheck()?RV_ALARM_PTZ:0;
	m_alarmCFG[m_almIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_RECORD))->GetCheck()?RV_ALARM_RECORD:0;
	m_alarmCFG[m_almIdx].struHandle.dwActionFlag |= ((CButton*)GetDlgItem(IDC_CHECK_OUTPUT))->GetCheck()?RV_ALARM_OUT:0;
...
skipsave:
	...
	((CButton*)GetDlgItem(IDC_CHECK_UPLOAD))->SetCheck((m_alarmCFG[almIdx].struHandle.dwActionFlag&RV_ALARM_UPLOAD)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_LOCALTIP))->SetCheck((m_alarmCFG[almIdx].struHandle.dwActionFlag&RV_ALARM_TIP)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_LOCALTOUR))->SetCheck((m_alarmCFG[almIdx].struHandle.dwActionFlag&RV_ALARM_TOUR)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_SENDMAIL))->SetCheck((m_alarmCFG[almIdx].struHandle.dwActionFlag&RV_ALARM_MAIL)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_PTZ))->SetCheck((m_alarmCFG[almIdx].struHandle.dwActionFlag&RV_ALARM_PTZ)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_RECORD))->SetCheck((m_alarmCFG[almIdx].struHandle.dwActionFlag&RV_ALARM_RECORD)?1:0);
	((CButton*)GetDlgItem(IDC_CHECK_OUTPUT))->SetCheck((m_alarmCFG[almIdx].struHandle.dwActionFlag&RV_ALARM_OUT)?1:0);
...
void CConfigAlarmAlarm::GetAlarmInCFG(RV_ALARMIN_CFG *cfg)
{
	...
	memcpy(cfg, m_alarmCFG, RV_MAX_ALARM_IN_NUM*sizeof(RV_ALARMIN_CFG));
}
